...
**Summary:**
Comments are used to leave notes in the code and are ignored by the JavaScript engine. There are two types of comments:
- **Single-line comments:** Use `//` at the beginning of the comment.
  ```javascript
...
let verb = "jumps";
let adverb = "quickly";
let sentence = "The " + adjective + " " + noun + " " + verb + " over the lazy dog " + adverb + ".";
...
#### Syntax
```javascript
let nestedArray = [[value1, value2], [value3, value4]];
```

#### Examples
```javascript
let numberPairs = [[1, 2], [3, 4], [5, 6]];
...
#### Syntax
```javascript
let shoppingList = [["item1", quantity1], ["item2", quantity2]];
```
